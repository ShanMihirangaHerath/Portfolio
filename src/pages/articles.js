...
const Artile = ({ image, title, date, link }) => {
  return (
    <motion.li
      initial={{ y: 200 }}
...
const HighlightedArticle = ({ image, title, time, summery, link }) => {
  return (
    <li className="col-span-1 w-full p-4 relative bg-light border border-solid border-dark rounded-2xl dark:bg-dark dark:border-light">
...
const articles = () => {
  return (
    <>
      <Head>
        <title>ShanDev | Articles</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout className="pt-16">
          <AnimatedText
            text="Words Have the Power to Shape the World!"
