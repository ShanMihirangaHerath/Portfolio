...
const HighlightedProjects = ({ type, title, summery, image, link, github }) => {
  return (
    <article
      className="w-full flex items-center justify-between rounded-3xl rounded-br-2xl relative border border-solid border-dark bg-light shadow-2xl p-9
    ...
    >
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6">
        ...
        <p className="my-2 font-medium text-dark/75 dark:text-light">
          {summery}
        </p>
